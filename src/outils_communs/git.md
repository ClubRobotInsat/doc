...
On héberge nos projets sur [GitHub](https://github.com/ClubRobotInsat). C'est un site qui permet de gérer des projets `git` en ligne. Il est très pratique car il permet de visualiser les modifications, de gérer les différentes versions, de faire des *pull requests* pour proposer des modifications, etc.
...
- [apprendre visuellement git](https://learngitbranching.js.org/) : un site qui permet d'apprendre à utiliser `git` en ligne de commande en visualisant les modifications
- [git - petit guide](https://rogerdudler.github.io/git-guide/index.fr.html) : un guide très simple pour apprendre les bases de `git`
